...
config['MUON_CUTS']               = "((isTrackerMuon || isGlobalMuon) && abs(eta)<2.4 && pt>5)"
...
if (not options.isMC): 
   process.source.firstRun  = cms.untracked.uint32(274094)
...
process.muonEffs = cms.EDAnalyzer("TagProbeFitTreeProducer",
	...
	passingHTTID  = cms.string("isMediumMuon && abs(userFloat('dXY')) < 0.045 && abs(userFloat('dZ')) < 0.2"),
        ...
        passingHTTIsoLoose = cms.string("userFloat('dBRelIso03') < 0.3"),
        passingHTTIsoTight = cms.string("userFloat('dBRelIso03') < 0.1"),
        passingHTTIsoLoose04 = cms.string(isolationDef+" < 0.3"),
        passingHTTIsoTight04 = cms.string(isolationDef+" < 0.1"),
