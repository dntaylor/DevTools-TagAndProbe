...
def runfit(args):
    ...
    idArgs = {
        ...
        'muon': {
            #'HppLooseID':                {'condition': [],                     'variable': 'passingHppLooseID',  'fitVars': ['bool passingHppLooseID']},
            #'HppLooseIsoFromLooseID':    {'condition': ['passingHppLooseID'],  'variable': 'passingHppLooseIso', 'fitVars': ['bool passingHppLooseID','bool passingHppLooseIso']},
            #'HppMediumID':               {'condition': [],                     'variable': 'passingHppMediumID', 'fitVars': ['bool passingHppMediumID']},
            #'HppMediumIsoFromMediumID':  {'condition': ['passingHppMediumID'], 'variable': 'passingHppMediumIso','fitVars': ['bool passingHppMediumID','bool passingHppMediumIso']},
            #'LooseID':                   {'condition': [],                     'variable': 'passingLoose',       'fitVars': ['bool passingLoose']},
            'LooseIsoFromLooseID':       {'condition': ['passingLoose'],       'variable': 'probe_isoR04<0.25',  'fitVars': ['bool passingLoose','float probe_isoR04']},
            #'MediumID':                  {'condition': [],                     'variable': 'passingMedium',      'fitVars': ['bool passingMedium']},
            #'LooseIsoFromMediumID':      {'condition': ['passingMedium'],      'variable': 'probe_isoR04<0.25',  'fitVars': ['bool passingMedium','float probe_isoR04']},
            #'TightIsoFromMediumID':      {'condition': ['passingMedium'],      'variable': 'probe_isoR04<0.15',  'fitVars': ['bool passingMedium','float probe_isoR04']},
            #'MediumIDICHEP':             {'condition': [],                     'variable': 'passingMediumICHEP', 'fitVars': ['bool passingMediumICHEP']},
            #'LooseIsoFromMediumIDICHEP': {'condition': ['passingMediumICHEP'], 'variable': 'probe_isoR04<0.25',  'fitVars': ['bool passingMediumICHEP','float probe_isoR04']},
            #'TightIsoFromMediumIDICHEP': {'condition': ['passingMediumICHEP'], 'variable': 'probe_isoR04<0.15',  'fitVars': ['bool passingMediumICHEP','float probe_isoR04']},
            #'TightID':                   {'condition': [],                     'variable': 'passingTight',       'fitVars': ['bool passingTight']},
            #'TightIsoFromTightID':       {'condition': ['passingTight'],       'variable': 'probe_isoR04<0.15',  'fitVars': ['bool passingTight','float probe_isoR04']},
